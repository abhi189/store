package com.budderfly.sites.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.budderfly.sites.domain.AbstractAuditingEntity;
import com.budderfly.sites.domain.EntityAuditEvent;
import com.budderfly.sites.repository.EntityAuditEventRepository;
    ...
    public void writeAuditEvent(Object target, EntityAuditAction action) {
        ...
        try {
            ...
            if (auditedEntity != null) {
                // In order to avoid same issues found in https://jira-cme.atlassian.net/browse/BD-551
                // These values do not need to be stored.
